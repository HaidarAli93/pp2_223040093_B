...
public class JenisMemberDao {
    ...
    public int update(JenisMember jenisMember) {
        int result;
        try (SqlSession session = sqlSessionFactory.openSession()) {
            result = session.insert("mapper.JenisMemberMapper.update", jenisMember);
        }
        return result;
    }
    ...
    public int delete(JenisMember jenisMember) {
        int result;
        try (SqlSession session = sqlSessionFactory.openSession()) {
            result = session.insert("mapper.JenisMemberMapper.delete", jenisMember);
        }
        return result;
    }
    ...
    public List<JenisMember> findAll() {
        ...
        try (SqlSession session = sqlSessionFactory.openSession()) {
            result = session.insert("mapper.JenisMemberMapper.findAll");
        }
        return result;
    }
}
